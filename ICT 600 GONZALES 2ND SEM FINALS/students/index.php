<?php 
include_once 'user_select_exe.php';
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-outline-primary me-2" aria-current="page" href="index.php">Students</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="containter-fluid">
    ...
    <a href="add.php">Add new Student Grade</a>
    </div>

    <div>
        <table class="table table-info table-hover table-bordered border-primary table-striped">
        <thead>
            <tr>
